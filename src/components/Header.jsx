      ...
      <div className="flex items-center gap-4">
        <div className="bg-[#1D1D1D80] rounded-xl">
          <select className="bg-inherit p-2 rounded-xl text-white dark:text-black dark:bg-white">
            <option className="bg-white dark:bg-black text-black dark:text-white" value="">Ru</option>
            <option className="bg-white dark:bg-black text-black dark:text-white" value="">Uzb</option>
            <option className="bg-white dark:bg-black text-black dark:text-white" value="">Eng</option>
          </select>
        </div>
